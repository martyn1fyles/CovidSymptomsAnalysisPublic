...
```{r}
p2_children = read.csv("Data/Alignments/AlignedUMAP/Pillar2/children_tight.csv")
p2_adult = read.csv("Data/Alignments/AlignedUMAP/Pillar2/adult_tight.csv")
p2_elder = read.csv("Data/Alignments/AlignedUMAP/Pillar2/elder_tight.csv")
...
```{r}
sgss_children = read.csv("Data/Alignments/AlignedUMAP/SGSS/children_tight.csv")
sgss_adult = read.csv("Data/Alignments/AlignedUMAP/SGSS/adult_tight.csv")
sgss_elder = read.csv("Data/Alignments/AlignedUMAP/SGSS/elder_tight.csv")
...
```{r}
cis_children = read.csv("Data/Alignments/AlignedUMAP/CIS/children_tight.csv")
cis_adult = read.csv("Data/Alignments/AlignedUMAP/CIS/adult_tight.csv")
cis_elder = read.csv("Data/Alignments/AlignedUMAP/CIS/elder_tight.csv")
...
```{r}
css_children = read.csv("Data/Alignments/AlignedUMAP/CSS/children_tight.csv")
css_adult = read.csv("Data/Alignments/AlignedUMAP/CSS/adult_tight.csv")
css_elder = read.csv("Data/Alignments/AlignedUMAP/CSS/elder_tight.csv")
...
ggsave('Figures/Alignment/p2_age_stratified_tight.png', arranged, height = 9, width = 9)
```
...
ggsave('Figures/Alignment/sgss_age_stratified_tight.png', arranged, height = 9, width = 9)
```
...
ggsave('Figures/Alignment/cis_age_stratified_tight.png', arranged, height = 9, width = 9)
```
...
ggsave('Figures/Alignment/css_age_stratified_tight.png', arranged, height = 9, width = 9)
```
